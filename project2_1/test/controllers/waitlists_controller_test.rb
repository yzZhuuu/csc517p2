...
class WaitlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create waitlist" do
    assert_difference('Review.count') do
      post waitlists_url, params: { waitlist: { subject: @waitlist.subject, message: @waitlist.message} }
    end

    assert_redirected_to waitlist_url(Review.last)
  end
  ...
  test "should update waitlist" do
    patch waitlist_url(@waitlist), params: { waitlist: { subject: @waitlist.subject, message: @waitlist.messag } }
